...
Revision ID: 079ce79e8a11
Revises: 
Create Date: 2025-04-28 13:45:42.890174
...
def upgrade() -> None:
    ...
    sa.Column('preferred_circle_id', sa.Integer(), nullable=True),
    sa.Column('previous_education', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['center_id'], ['centers.id'], ),
    sa.ForeignKeyConstraint(['id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['preferred_circle_id'], ['study_circles.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_circle_students_id'), 'circle_students', ['id'], unique=False)
    ...
    sa.Column('test_type', sa.Enum('written', 'oral', 'practical', 'comprehensive', name='testtype'), nullable=True),
    sa.Column('status', sa.Enum('scheduled', 'completed', 'cancelled', 'pending', name='teststatus'), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_circle_students_id'), table_name='circle_students')
